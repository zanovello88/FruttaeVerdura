...
<main>
    ...
    <div class="container">
        <div class="card" style="display: flex; flex-wrap: wrap; justify-content: space-between;">
            <div class="search-form">
                <form id="searchForm" name="searchForm" action="Dispatcher" method="post">
                    ...
                    <button type="submit" form="searchForm" class="search-button">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.966 56.966" width="20" height="20">
